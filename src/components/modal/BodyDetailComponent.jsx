        ...
        <div className='max-h-64 3xl:max-h-[554px] overflow-scroll flex flex-col items-between font-Lato px-5'>
            <div className='text-start ml-auto'>
                ...
                <div className='flex items-start justify-end gap-4'>
                    ...
                    <div className='w-2/3 bg-chats-lavenderMist rounded-lg px-2 py-4 text-slate-600'>
                        <p className='pt-2'>
            ...
            <div className='text-start ml-auto'>
                ...
                <div className='flex items-start justify-end gap-4'>
                    ...
                    <div className='w-2/3 bg-chats-lavenderMist rounded-lg px-2 text-slate-600'>
                        <p className='pt-2'>
            ...
            <div className='mt-5 w-full relative flex items-center'>
                ...
                <h3 className='mx-4 text-[#EB5757] font-bold'>New Message</h3>
                <div className='flex-1 h-0.5 bg-[#EB5757]'></div>
            </div>
