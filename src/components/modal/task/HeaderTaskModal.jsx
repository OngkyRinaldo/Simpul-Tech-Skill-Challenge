...
const HeaderTaskModal = () => {
    // State untuk mengelola tampilan opsi
    const [showOption, setShowOption] = useState(false);

    // Mengganti status tampilan opsi
    const handleOption = () => {
        setShowOption(!showOption);
    };

    return (
        <div className='w-72 sm:w-96 md:min-w-[550px] 3xl:w-modalWidth bg-white p-5 xl:pl-[29px] xl:pr-[22px] xl:pt-[19px] rounded-t-md'>
            ...
            {/* Tampilkan opsi jika showOption bernilai true */}
            {showOption && (
                <>
